    ...
    >
      ...
      <div className='grid grid-cols-1 gap-6 p-6 md:grid-cols-3'>
        {courses.map((course) => (
          <Card
            key={course.id}
            className='relative overflow-hidden font-sans border-2 text-white transition-colors border-purple-500 bg-[#331C1C80]/50 hover:border-purple-400'
          >
            ...
            <CardContent className='relative p-6 space-y-4'>
              ...
              <div className='space-y-2 text-lg text-gray-200'>
                ...
                <p>
                  Вартість 1 заняття:{' '}
                  <span className='font-bold'>{course.pricePerLesson} грн</span>
                </p>
                <p>
                  Тривалість курсу:{' '}
